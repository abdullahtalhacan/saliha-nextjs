...
const Footer = () => {
  return (
    <footer className="w-full bg-white/50 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Changelog</a></p>
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Careers</a> <span className="inline text-blue-600 dark:text-blue-500">— Were hiring</span></p>
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Customers</a></p>
        ...
        <div>
          ...
          <div className="mt-3 grid space-y-3 text-sm">
            ...
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Help & Support</a></p>
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">eBook</a></p>
            <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Whats New</a></p>
          ...
          <div className="flex items-center gap-x-3">
            ...
            <div className="hs-dropdown relative inline-flex [--placement:top-left]">
              ...
              <div className="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:divide-gray-700" aria-labelledby="footer-language-dropdown">
                ...
                <a className="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500" href="#">
                  <svg className="w-3 h-3 rounded-full" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-cn" viewBox="0 0 512 512">
                    <defs>
