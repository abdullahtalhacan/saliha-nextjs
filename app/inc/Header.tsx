    ...
    <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      <nav className="mt-6 relative max-w-[85rem] w-full mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto" aria-label="Global">
        <div className="flex items-center justify-between">
          <a className="flex-none text-xl font-semibold" href="#" aria-label="Brand">Saliha Nur Can</a>
        ...
        <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
          <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
            <Link className="font-medium text-gray-500 hover:text-gray-400 md:py-6" href="#">home</Link>
            <Link className="font-medium text-blue-600 md:py-6 dark:text-blue-500" href="#" aria-current="page">about</Link>
            <Link className="font-medium text-gray-500 hover:text-gray-400 md:py-6" href="#">contact</Link>

            <Link className="flex items-center relative group gap-x-2 font-medium text-gray-500 hover:text-blue-600 md:border-s md:border-zinc-950/20 md:my-6 md:ps-6" href="#">
