...
const page = () => {
  return (
        <div className="flex flex-col space-y-6 py-10">
            <div className="bg-white px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
                <div className="max-w-4xl">
                    ...
                    <div className="flex w-full sm:items-center gap-x-5 sm:gap-x-3">
                        ...
                        <div className="flex justify-between items-center gap-x-2">
                            ...
                            <div>
                            <button type="button" className="py-1.5 px-2.5 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">
